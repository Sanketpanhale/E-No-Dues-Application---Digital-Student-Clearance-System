...
class TGP extends StatelessWidget {
  const TGP({super.key});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("TG & Project Guide Verification"),
        actions: [
          IconButton(
            ...
            itemBuilder: (context, index) {
              ...
              return ListTile(
                ...
                trailing: Row(
                  ...
                  children: [
                    Switch(
                      value: data.containsKey('TG & Project Guide')
                          ? data['TG & Project Guide'] as bool
                          : false,
                      onChanged: (val) async {
                        await FirebaseFirestore.instance
                            .collection('requesters')
                            .doc(doc.id)
                            .update({'TG & Project Guide': val});
                      },
